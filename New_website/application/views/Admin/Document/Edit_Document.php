<div class="container-fluid">
    <div class="page-head">
        <h5 class="header-title">Edit Document</h5>      
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="general-label">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('Admin/Document/update_document/'.$about->id);?>"> 
